...
def main():
    ...
    # ========== 在这里修改本次运行的参数 ==========
    input_path   = "二、函数的概念.md"              # 待切分的 Markdown 文件路径
    source       = "二、函数的概念.md"              # 存入 JSON 的 source 字段（来源路径）
    section      = "函数的概念"                 # 存入 JSON 的 section 字段（小节名）
    section_id   = None                           # 自动从 chapters.db 查找，不知道则填 None
    chapter_db   = "chapters.db"    # 章节数据库路径
    # ==============================================
